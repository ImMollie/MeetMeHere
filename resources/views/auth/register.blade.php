                  ...
                  <form class="mx-1 mx-md-4" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="d-flex flex-row align-items-center mt-5">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label">{{__('translation.register.nickname')}}</label>
				            @error('nickname')
                    ...
                    <div class="d-flex flex-row align-items-center mt-2">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label">{{__('translation.register.firstname')}}</label>
				            @error('firstname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="d-flex flex-row align-items-center mt-2">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label">{{__('translation.register.lastname')}}</label>
				            @error('lastname')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                    ...
                    <div class="d-flex flex-row align-items-center mt-2">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label">{{__('translation.register.email')}}</label>
				            @error('email')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
              ...
              @error('number')
                    ...
                    <div class="d-flex flex-row align-items-center mt-2">
                        ...
                        <div class="form-outline flex-fill mb-0">
                          ...
                          <label class="form-label">{{__('translation.register.phonenumber')}}</label>
				            @error('phonenumber')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
