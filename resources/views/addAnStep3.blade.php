...
<div class="container h-100 pt-5">
    <div class="formCard p-md-4" style="border-radius: 25px;">
                ...
                <div class="row">
                    <div class="col" style="border-right: 5px dotted #bbb; border-radius:5px;">                
                        ...
                        <div class="form-group">                                                         
                            ...
                            <input type="text" id="address" class="form-control" name="address" placeholder="Address" readonly>                         
                        </div> 
            ...
            <div class="col align-self-start">
                <div class="row">
                    <div class="col">
                        ...
                        <input type="date" id="date1" class="form-control" min="{{ date('Y-m-d') }}" name="date">
                        <img src="https://img.freepik.com/free-vector/illustration-calendar-icon_53876-5588.jpg?w=826&t=st=1665699177~exp=1665699777~hmac=408590667928e396b0be3765548edc8c37629b7731797ef52e18b47b0d8c1f36">
                            <div class="form-check">
                                <input class="form-check-input" name="oneDay" id="oneDay" type="checkbox" onchange="dateDisabled()">
                    ...
                    <div class="col">
                        ...
                        <input type="date" id="date2" class="form-control oneDay" min="{{ date('Y-m-d') }}" name="date2">
                        <img src="https://img.freepik.com/free-vector/illustration-calendar-icon_53876-5588.jpg?w=826&t=st=1665699177~exp=1665699777~hmac=408590667928e396b0be3765548edc8c37629b7731797ef52e18b47b0d8c1f36">
                    </div>                    
                </div>        
            </div>
        ...
        <div class="row justify-content-end">						
            ...
            <div class="modal fade" id="location-modal" tab-index="-1" role="dialog" aria-labelled="location-modal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-info" data-bs-dismiss="modal"><i class="fa fa-check"></i>Done</button>
                        </div> 
                    </div>
                </div>
            </div>                   
